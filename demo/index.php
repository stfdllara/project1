...
<input type="text" name="hero's name" class="form-control" placeholder="Hero's Name" autofocus>
<div class="form-group">
<textarea name="hero's real name" rows="2" class="form-control" placeholder="Hero's Real Name"></textarea>
